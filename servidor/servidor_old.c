...
int main(int argc, char **argv) {
  ...
  // crc = (uLong *)(obuffer + sizeof(struct hdr) + PAYLOAD_SIZE);//si lo uso
  // como puntero luego no puedo moverlo de lugar sin romper alguna otra
  // chingadera
...
/*
                                                                       __                               
                                                                      /  |                              
  ______    _______   ______          ______   _____  ____    ______  $$/   ______   ________   ______  
 /      \  /       | /      \        /      \ /     \/    \  /      \ /  | /      \ /        | /      \ 
 $$$$$$  |/$$$$$$$/  $$$$$$  |      /$$$$$$  |$$$$$$ $$$$  |/$$$$$$  |$$ |/$$$$$$  |$$$$$$$$/  $$$$$$  |
 /    $$ |$$ |       /    $$ |      $$    $$ |$$ | $$ | $$ |$$ |  $$ |$$ |$$    $$ |  /  $$/   /    $$ |
/$$$$$$$ |$$ \_____ /$$$$$$$ |      $$$$$$$$/ $$ | $$ | $$ |$$ |__$$ |$$ |$$$$$$$$/  /$$$$/__ /$$$$$$$ |
...
*/
    ...
    if (NULL == archivo)             // si el archivo no existe:
    {
      ...
      do {
        if (retry == false) { // si no hay que reintentar lee datos
          ...
          /*crc = crc32(0L, (const Bytef *)opayload, bytes_leidos);//que aqui no
          va el calculo :| memcpy(opayload + bytes_leidos, &crc,
          sizeof(crc));//un pinche hack culero*/
        }
        ...
        if (0 < bytes_leidos) { // si se leyeron mas de 0b se envia
          ...
          crc = crc32(0L, (const Bytef *)obuffer,
                      sizeof(struct hdr) + bytes_leidos);
    ...
    /*
                                           ...
                                           __                                        __                     
                                      /  |                                      /  |                    
  ______    _______   ______         _$$ |_     ______    ______   _____  ____  $$/  _______    ______  
 /      \  /       | /      \       / $$   |   /      \  /      \ /     \/    \ /  |/       \  /      \ 
 $$$$$$  |/$$$$$$$/  $$$$$$  |      $$$$$$/   /$$$$$$  |/$$$$$$  |$$$$$$ $$$$  |$$ |$$$$$$$  | $$$$$$  |
 /    $$ |$$ |       /    $$ |        $$ | __ $$    $$ |$$ |  $$/ $$ | $$ | $$ |$$ |$$ |  $$ | /    $$ |
/$$$$$$$ |$$ \_____ /$$$$$$$ |        $$ |/  |$$$$$$$$/ $$ |      $$ | $$ | $$ |$$ |$$ |  $$ |/$$$$$$$ |
